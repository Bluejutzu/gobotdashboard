    ...
    <div className="flex min-h-screen flex-col bg-black text-white">
      <main className="flex-1">
          ...
          <div className="container relative z-10 mx-auto px-4 text-center">
            ...
            >
              ...
              <div className="space-y-6 mt-8">
                <p className="text-2xl md:text-3xl text-white/80 font-light">Multi-purpose Discord Bot.</p>
          ...
          <div className="container relative z-10 mx-auto px-4">
            ...
            >
              ...
              <p className="mt-6 text-xl md:text-2xl text-white/70 max-w-3xl mx-auto">
                Gobot is in over <span className="font-bold text-white">866,600 servers</span>, reaching more than{" "}
                <span className="font-bold text-white">297.3 million users</span>.
              </p>
            </div>

            <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
              <StatCard title="866,600+" description="Discord Servers" color="blue" delay={0} inView={statsInView} />
              <StatCard title="297.3M+" description="Discord Users" color="purple" delay={300} inView={statsInView} />
              <StatCard title="99.9%" description="Uptime" color="teal" delay={600} inView={statsInView} />
            </div>
          </div>
        </section>
        ...
        <section ref={ctaRef} className="py-32 relative overflow-hidden">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-bold mb-6 text-white">Ready to enhance your Discord server?</h2>
