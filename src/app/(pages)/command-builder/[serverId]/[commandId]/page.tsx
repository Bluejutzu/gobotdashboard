            ...
            <div className="w-80 border-r border-[#2a2d3d] flex flex-col">
                ...
                <div className="p-4 border-b border-[#2a2d3d]">
                    <p className="text-sm text-gray-400 mb-2">
                        ...
                        <span className="text-[#22c55e]">Conditions</span> to add them to your command. Connect the
                        corresponding colors to create your command flow.
                    </p>
                </div>
                            ...
                            return (
                                <g key={connection.id} className="animate-fade-in">
                                    <path
                                        ...
                                        strokeWidth="2"
                                        strokeDasharray={
                                            fromBlock.blockType === "conditions" && connection.fromSocket === "else"
                                                ? "5,5"
                                                : "none"
                                        }
                                        className={
            ...
            <div className="bg-[#252839] p-3 border border-[#2a2d3d] border-t-0">
                <div className="text-xs text-gray-300">
                    ...
                    {block.type === "embed-reply" && (
                        <div className="truncate">{block.data.title || "No embed title"}</div>
                    )}
                    ...
                    {block.type === "text-option" && (
                        <div className="truncate">Option: {block.data.name || "unnamed"}</div>
                    )}
                    ...
                    <div className="space-y-4 animate-fade-in">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={e =>
                                    onChange({
                                        channel: e.target.value as "same_channel" | "dm" | "custom_channel"
                                    })
                                }
                            >
                    ...
                    <div className="space-y-4 animate-fade-in">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={e =>
                                    onChange({
                                        comparisonType: e.target.value as BlockData["data"]["comparisonType"]
                                    })
                                }
                            >
