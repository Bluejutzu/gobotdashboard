        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground line-clamp-2">{cmd.description || "No description provided"}</p>
            </div>
          </div>
  ...
  if (error) {
    return (
      <Card className="bg-destructive/10 border-destructive/20">
        <CardContent className="p-6">
          <p className="text-destructive font-medium">Failed to load commands</p>
...
export default function CommandsPage({ params }: { params: Usable<{ id: string }> }) {
