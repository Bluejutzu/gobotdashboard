        ...
        <div className="flex min-h-screen flex-col">
            ...
            <main className="flex-1">
                ...
                <section className="relative overflow-hidden bg-background py-24 md:py-32">
                    ...
                    <div className="container relative z-10">
                        <div className="max-w-3xl mx-auto text-center">
                            <h1 className="text-4xl font-bold md:text-5xl lg:text-6xl mb-6">Theme Import & Export</h1>
                            <p className="text-xl text-muted-foreground mb-8">
                                Share your custom themes with others or backup your theme collection
                            </p>
                ...
                <section className="py-16">
                    <div className="container">
                        <h2 className="text-3xl font-bold text-center mb-8">Current Theme</h2>
                        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                            This is your currently active theme. You can export it using the button below.
                        </p>
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <code className="text-sm">{currentTheme.borderRadius}px</code>
                                        </div>

                                        <div className="pt-4">
                                            <ThemeImportExport theme={currentTheme} variant="default" />
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
                ...
                <section className="py-16 bg-black/30">
                    <div className="container">
                        ...
                        <div className="max-w-2xl mx-auto">
                            <CodeBlock code={themeJsonExample} language="json" filename="my-custom-theme.json" />

                            <div className="mt-8 space-y-4">
                                <h3 className="text-xl font-semibold">Required Properties</h3>
                                <ul className="list-disc pl-6 space-y-2">
                                    <li>
                                        <code className="text-sm">name</code> - The name of the theme (string)
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <code className="text-sm">borderRadius</code> - Border radius in pixels (number)
                                    </li>
                                </ul>

                                <h3 className="text-xl font-semibold mt-6">Optional Properties</h3>
                                <ul className="list-disc pl-6 space-y-2">
                                    <li>
                                        <code className="text-sm">id</code> - Unique identifier for the theme (string)
                                    </li>
                                    <li>
