					...
					<div className="container relative z-10">
						<div className="max-w-3xl mx-auto text-center">
							...
							<p className="text-xl text-muted-foreground animate-slide-in animation-delay-500">
								Explore how the theming system applies across different
								components
							</p>
							<div className="mt-8">
								<ThemeSelector />
								...
								<div className="grid md:grid-cols-2 gap-8">
										...
										<CardContent className="space-y-6">
											...
											<div className="space-y-2">
												...
												<Card className="w-full max-w-sm">
													...
													<CardContent>
														<p>
															This is a standard card using Tailwind classes.
														</p>
													</CardContent>
													<CardFooter>
									...
									<Card>
										<CardHeader>
											...
											<CardDescription>
												Details of the currently applied theme
											</CardDescription>
										</CardHeader>
										...
										<CardContent className="space-y-6">
											<div className="space-y-2">
												...
												<ThemedCard variant="outline" className="p-4 mt-4">
													...
													<p className="text-sm text-muted-foreground">
														This card has a border using the primary theme
														color.
													</p>
												</ThemedCard>
											</div>
											...
											<div className="space-y-2">
												...
												>
													<p>
														This element uses CSS variables directly in the
														className and style.
													</p>
												</div>
  ...
  border-radius: var(--theme-radius);
											...
											<div>
												...
												<ul className="text-sm space-y-1">
													...
													<li>
														<code>--theme-secondary</code>: Secondary color
														(hex)
													</li>
													<li>
								...
								<div className="grid md:grid-cols-2 gap-8">
									<Card>
										<CardHeader>
											...
											<CardDescription>
												Using inline styles with theme values
											</CardDescription>
										</CardHeader>
										<CardContent className="space-y-6">
											<div className="space-y-2">
												...
												<div className="flex flex-wrap gap-2 mt-4">
													<ThemedButton colorScheme="secondary">
														Secondary
													</ThemedButton>
													<ThemedButton colorScheme="accent">
														Accent
													</ThemedButton>
									...
									<Card>
										<CardHeader>
											...
											<CardDescription>
												Creating themed components with hooks
											</CardDescription>
										</CardHeader>
										<CardContent className="space-y-4">
											<div>
