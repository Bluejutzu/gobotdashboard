					...
					<div className="container relative z-10">
						<div className="max-w-3xl mx-auto text-center">
							...
							<p className="text-xl text-muted-foreground animate-slide-in animation-delay-500">
								Gobot was created with a simple mission: to provide Discord
								server owners with the most powerful, customizable, and
								user-friendly bot experience possible.
							</p>
						</div>
					</div>
				</section>
						...
						<div className="grid md:grid-cols-2 gap-12 items-center">
							<div className="space-y-6 animate-fade-in-up">
								...
								<p className="text-lg text-muted-foreground">
									At Gobot, we believe that Discord communities should have
									access to powerful tools without complicated setup or premium
									paywalls. Our mission is to empower server owners with
									everything they need to create engaging, safe, and thriving
									communities.
								</p>
								<p className="text-lg text-muted-foreground">
					...
					<div className="container relative z-10">
						<div className="text-center mb-12 animate-fade-in-up">
							...
							<h2 className="text-3xl font-bold md:text-4xl">
								Meet the people behind Gobot
							</h2>
							<p className="mt-4 text-xl text-muted-foreground">
								Our dedicated team works tirelessly to make Gobot the best
						...
						<div className="max-w-3xl mx-auto animate-fade-in-up">
							<Accordion type="single" collapsible className="w-full">
								<AccordionItem value="item-1">
									...
									<AccordionContent>
										Yes! Gobot is completely free to use with all core features
										available to everyone. We believe in providing powerful
										tools without paywalls.
									</AccordionContent>
								</AccordionItem>
								<AccordionItem value="item-2">
									<AccordionTrigger>
										How do I add Gobot to my server?
									</AccordionTrigger>
									<AccordionContent>
										{` Adding Gobot is simple! Just click the "Add to Discord" button on our homepage, authorize the bot`}
										with your Discord account, and select the server you want to
										add it to.
									</AccordionContent>
								</AccordionItem>
								<AccordionItem value="item-3">
									<AccordionTrigger>
										What permissions does Gobot need?
									</AccordionTrigger>
									<AccordionContent>
								...
								<AccordionItem value="item-4">
									<AccordionTrigger>
										How can I customize Gobot for my server?
									</AccordionTrigger>
									<AccordionContent>
										After adding Gobot to your server, you can access the
										dashboard to customize all aspects of the bot, including
										prefix, welcome messages, auto-roles, moderation settings,
										and more.
									</AccordionContent>
								</AccordionItem>
								...
								<AccordionItem value="item-6">
									...
									<AccordionContent>
										You can report issues or suggest features through our
										support server on Discord or by using the contact form on
										our website. We value community feedback and actively
