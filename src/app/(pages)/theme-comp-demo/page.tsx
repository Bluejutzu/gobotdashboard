					...
					<div className="container">
						...
						<div className="grid md:grid-cols-2 gap-8">
							<Card>
								...
								<CardContent>
									<p className="mb-4">
										Compare two themes side-by-side to see the visual
										differences and make an informed choice. The comparison tool
										shows:
									</p>
							...
							<Card>
								...
								<CardContent>
									<p className="mb-4">
										Explore themes in detail with our comprehensive showcase.
				...
				<section className="py-16">
					<div className="container">
						...
						>
							...
							<TabsContent
								value="comparison"
								className="border rounded-md mt-6 overflow-hidden"
							>
						...
						<div className="max-w-3xl mx-auto space-y-12">
							<div className="flex flex-col md:flex-row gap-8 items-center">
								<div className="md:w-1/2">
									<h3 className="text-xl font-bold mb-4">
										1. Select Themes to Compare
									</h3>
									<p>
										In the theme selector, choose two themes you want to compare
										by clicking the comparison checkbox. Once you've selected
										two themes, click the "Compare" button to see them side by
										side.
									</p>
								</div>
							...
							<div className="flex flex-col md:flex-row gap-8 items-center">
								...
								<div className="md:w-1/2 order-0 md:order-1">
									...
									<p>
										The comparison view shows both themes side by side,
										highlighting the visual differences in UI elements, colors,
										and styles. You can see how each theme affects buttons,
										cards, form elements, and more.
									</p>
								</div>
							</div>
							...
							<div className="flex flex-col md:flex-row gap-8 items-center">
								<div className="md:w-1/2">
									<h3 className="text-xl font-bold mb-4">
										3. Explore Theme Showcase
									</h3>
									<p>
										The theme showcase provides a comprehensive view of each
										theme with interactive previews and detailed information.
										Browse through featured themes and see how they look in
										various UI contexts.
									</p>
								</div>
								<div className="md:w-1/2 bg-white/5 p-4 rounded-lg">
