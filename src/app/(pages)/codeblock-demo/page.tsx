	...
	return (
		<div className="container mx-auto py-12 px-4">
			...
			<section className="mb-12">
				...
				<p className="mb-4">
					The <code>useThemeStyles</code> hook provides access to the current
					theme's colors and properties.
				</p>
				<CodeBlock
					code={useThemeStylesExample}
					language="tsx"
			...
			<section className="mb-12">
				...
				<p className="mb-4">
					The <code>ThemeWrapper</code> component is a convenient way to apply
					theme styles to any content.
				</p>
				<CodeBlock
					code={themeWrapperExample}
					language="tsx"
					filename="components/another-component.tsx"
				/>
			</section>
		</div>
	);
