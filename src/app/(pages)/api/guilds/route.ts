 ...
 *
 * Validates that both `userId` and `supabase_user_id` are provided in the request body. Returns a JSON response containing the server list or an error message if validation fails or an internal error occurs.
 *
