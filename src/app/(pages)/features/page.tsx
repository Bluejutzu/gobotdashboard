	...
	return (
		<div className="flex min-h-screen flex-col bg-black text-white">
				...
				<div className="container relative z-10">
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
							Gobot provides a comprehensive suite of tools to manage, moderate,
							and enhance your Discord community experience.
						</p>
					</div>
				</div>
			</section>
				...
				<div className="container relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-white/70 max-w-3xl mx-auto">
							Powerful moderation tools to help you manage your community and
							keep it safe from spam, inappropriate content, and disruptive
							users.
						</p>
					</div>
						...
						<div className="flex flex-col md:flex-row items-start md:items-center gap-6">
							<div className="flex-1">
								...
								<p className="text-white/70">
									Access a comprehensive dashboard to view server activity,
									moderation logs, and user reports. Configure auto-moderation
									settings and manage your server from anywhere.
								</p>
							</div>
							<Button
			...
			<section id="engagement" className="py-20 relative">
				...
				<div className="container relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-white/70 max-w-3xl mx-auto">
							Interactive features and games to keep your community active,
					...
					<div className="mt-16 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
						<div className="flex flex-col md:flex-row items-start md:items-center gap-6">
							<div className="flex-1">
								...
								<p className="text-white/70">
									Use our intuitive command builder to create custom commands
									with rich embeds, buttons, and interactive elements without
			...
			<section id="utility" className="py-20 relative">
				...
				<div className="container relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-white/70 max-w-3xl mx-auto">
							Useful utilities and integrations to streamline your server
					...
					<div className="mt-16 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
						<div className="flex flex-col md:flex-row items-start md:items-center gap-6">
							<div className="flex-1">
								...
								<p className="text-white/70">
									Get detailed insights into your server's growth, activity, and
									engagement with our comprehensive analytics dashboard.
								</p>
							</div>
							<Button
			...
			<section className="py-20 relative">
				...
				<div className="container relative z-10">
					<div className="text-center mb-16">
						<Badge className="mb-4 bg-white/10 text-white hover:bg-white/20 border-white/30">
							PRICING
						</Badge>
						...
						<p className="text-xl text-white/70 max-w-3xl mx-auto">
							Gobot is completely free to use with optional premium features for
							power users.
						</p>
					</div>
