	...
	return (
		<div
			className={cn(
				...
				getShadowStyle(),
				!available
					? "opacity-70 grayscale hover:grayscale-0 hover:opacity-80"
					: "hover:-translate-y-1",
		...
		>
			...
			<div className="p-1 relative z-10">
				...
				>
					...
					>
						...
						<div className="relative z-10">
							...
							<div className="flex items-center justify-center">
								...
								{period && (
									<span className="text-sm text-white/70 ml-1.5 self-end mb-1.5">
										/{period}
									</span>
								)}
							</div>
					...
					{/* Content */}
					<div className="p-6">
						<p className="text-white/70 text-center mb-6 min-h-[48px]">
							{description}
						</p>
						...
						<ul className="space-y-3 mb-8">
							{features.map((feature, index) => (
								<li
									key={index}
									className="flex items-start gap-3 text-white/80 group/feature"
								>
									<div
										className={cn(
			...
			{!available &&
				unavailableReason &&
				unavailableReason.toLowerCase().includes("coming") && (
