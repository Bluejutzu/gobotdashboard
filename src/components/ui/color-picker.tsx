...
export function ColorPicker({ color, onChange, label, className, popoverAlign = "center" }: ColorPickerProps) {
    ...
    return (
        <div className={cn("space-y-2", className)}>
            ...
            <Popover open={isOpen} onOpenChange={setIsOpen}>
                ...
                <PopoverContent className="w-64 p-3" align={popoverAlign} sideOffset={5}>
                    <div className="space-y-3">
                        <div className="flex items-center gap-2">
                            <div
                                ...
                                onClick={handleSwatchClick}
                            />
                            <Input value={localColor} onChange={handleHexChange} className="flex-1" placeholder="#000000" />
                        </div>
