...
import { Check, X, ChevronRight, Palette, Heart, Star, Plus, Download, Filter } from 'lucide-react'
...
export function ThemeSelector() {
    ...
    const featuredThemes = useMemo<ThemeData[]>(() => [
        {
            id: "default",
            name: "Default Blue",
            primary: "#0ea5e9",
        ...
        <>
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
                <DialogTrigger asChild>
                    <Button variant="outline" size="sm" className="gap-2 theme-transition">
                        <div
                ...
                <DialogContent className="sm:max-w-[650px] p-0 gap-0 bg-black border-white/10">
                    {isCreatingTheme ? (
                        ...
                        <div className="flex flex-col h-[600px]">
                            ...
                            <div className="flex-1">
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <TabsContent value="featured" className="h-full m-0">
                            ...
                            <DialogFooter className="px-6 py-4 border-t border-white/10 flex-row justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Button asChild size="sm">
                                        <Link href="/custom-themesv2" className="flex items-center gap-1">
    ...
    return (
        ...
        >
            ...
            <div className="relative h-32 overflow-hidden" style={gradientStyle}>
                ...
                {/* Mock UI elements to showcase the theme */}
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div
                        className="w-24 h-8 rounded-full flex items-center justify-center text-xs font-medium text-white shadow-md transform scale-90 group-hover:scale-100 transition-transform duration-300"
                ...
                {featured && (
                    <div className="absolute top-2 left-2 animate-fade-in">
                        <Badge variant="secondary" className="bg-black/40 backdrop-blur-sm text-xs">
            ...
            <div className="p-4">
                <div className="flex justify-between items-start mb-3">
                    <div>
                        ...
                        {theme.creator && <p className="text-xs text-white/60">by {theme.creator}</p>}
                    </div>
