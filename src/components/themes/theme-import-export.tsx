...
export function ThemeImportExport({ theme, variant = "outline", size = "sm" }: ThemeImportExportProps) {
    ...
    return (
        <div className="flex items-center gap-2">
            {/* Export Button */}
            <Button variant={variant} size={size} onClick={handleExport} title="Export Theme">
            ...
            <Dialog open={isImportDialogOpen} onOpenChange={setIsImportDialogOpen}>
                ...
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Upload a theme JSON file to import. You can drag and drop a file or click to browse.
                        </DialogDescription>
                    </DialogHeader>
