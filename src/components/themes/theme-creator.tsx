...
export function ThemeCreator({
	...
	const [themeName, setThemeName] = useState(
		initialTheme?.name || "My Custom Theme",
	);
	const [primaryColor, setPrimaryColor] = useState(
		initialTheme?.primary || currentTheme.primary,
	);
	const [secondaryColor, setSecondaryColor] = useState(
		initialTheme?.secondary || currentTheme.secondary,
	);
	const [accentColor, setAccentColor] = useState(
		initialTheme?.accent || currentTheme.accent,
	);
	const [borderRadius, setBorderRadius] = useState(
		initialTheme?.borderRadius || currentTheme.borderRadius,
	);
						...
						<div className="space-y-2">
							...
							>
								...
								<div className="text-sm text-white/70">
									Card content with your theme applied.
								</div>
								<div className="mt-4">
									<button
