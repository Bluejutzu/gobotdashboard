...
export function ThemeAnimation({ isActive, primaryColor, accentColor, onAnimationComplete }: ThemeAnimationProps) {
    ...
    return (
        <div className="fixed inset-0 pointer-events-none z-50 flex items-center justify-center">
            ...
            >
                {/* Ripple effects */}
                <div className="absolute inset-0 rounded-full animate-ripple" style={{ backgroundColor: primaryColor }} />
                <div
                ...
                <div
                    className={cn(
                        ...
                        animationStage >= 3 ? "opacity-100 translate-x-4 translate-y-4" : "opacity-0 translate-x-0 translate-y-0",
                    )}
                />
                <div
                    className={cn(
