    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Request an export of data for {serverName}</CardDescription>
            </CardHeader>
            <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Providing a clear reason helps administrators process your request faster.
                        </p>
                    </div>
                </form>
            </CardContent>
            <CardFooter className="flex justify-end">
                <Button type="submit" onClick={handleSubmit} disabled={isSubmitting || !requestReason.trim()}>
