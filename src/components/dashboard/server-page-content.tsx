							...
							<div className="flex items-start mb-4">
								...
								<div>
									...
									<p className="text-muted-foreground text-sm">
										Create fully customized messages called templates and pack
										them with your very own embeds, buttons and select menus.
									</p>
								</div>
							</div>
							<Button
								...
								asChild
							>
								<Link href={`/dashboard/servers/${id}/messages`}>
									Create template
								</Link>
							</Button>
						</CardContent>
						...
						<CardContent className="p-6">
							<div className="flex items-start mb-4">
								...
								<div>
									...
									<p className="text-muted-foreground text-sm">
										Allow users to report others and fully customize how to
										handle them.
									</p>
								</div>
							</div>
							<Button
								...
								asChild
							>
								<Link href={`/dashboard/servers/${id}/reports`}>
									Configure reports
								</Link>
							</Button>
						</CardContent>
					...
					<Card className="bg-background/60 backdrop-blur-sm border-slate-800 hover:border-slate-700 transition-colors">
						<CardContent className="p-6">
							...
							<Button
								...
								asChild
							>
								<Link href={`/dashboard/servers/${id}/roles`}>
									Show role messages
								</Link>
							</Button>
						</CardContent>
						...
						<CardContent className="p-6">
							<div className="flex items-start mb-4">
								...
								<div>
									...
									<p className="text-muted-foreground text-sm">
										Use artificial intelligence to assist you in moderating your
										server.
									</p>
								</div>
							</div>
							<Button
								...
								asChild
							>
								<Link href={`/dashboard/servers/${id}/ai-moderation`}>
									Configure AI
								</Link>
							</Button>
						</CardContent>
