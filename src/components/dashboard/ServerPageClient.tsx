			...
			<Tabs defaultValue="overview" className="w-full">
				...
				<TabsContent value="overview" className="space-y-6 mt-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Key information about your Discord server
							</CardDescription>
						</CardHeader>
						<CardContent>
						...
						{loading ? (
							...
							<div className="rounded-md border p-8 text-center">
								...
								<p className="text-sm text-muted-foreground mt-2">
									Commands used in your server will appear here
								</p>
							</div>
						)}
					</div>
					...
					<Card>
						...
						<CardContent>
							<p className="text-muted-foreground mb-4">
								This section allows you to customize commands, create custom
								commands, and view command usage statistics.
							</p>
							<Button asChild>
								<Link href={`/dashboard/servers/${id}/commands`}>
									Manage Commands
								</Link>
							</Button>
						</CardContent>
				...
				<TabsContent value="moderation" className="mt-6">
					<Card>
						...
						<CardContent>
							<p className="text-muted-foreground mb-4">
								Configure auto-moderation, word filters, anti-spam measures, and
				...
				<TabsContent value="settings" className="mt-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Configure your server and bot settings
							</CardDescription>
						</CardHeader>
						<CardContent>
							<p className="text-muted-foreground mb-4">
								Manage welcome messages, auto-roles, prefix settings, and other
