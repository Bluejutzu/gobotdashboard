 ...
 *
 * Renders an input field and controls for adding new blocked words, displays the current list as removable badges, and updates the parent settings state when the list changes.
 */
