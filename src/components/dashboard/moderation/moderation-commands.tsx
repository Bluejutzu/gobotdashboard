 ...
 *
 * Renders a command palette interface with descriptions, usage, and examples for each moderation command.
 */
	...
	return (
		<div className="space-y-6">
			<p className="text-gray-400">
				These commands are available to server moderators. Use them to manage
				your community.
			</p>
				...
				<CommandList>
					...
					<CommandGroup>
						{commands.map((command) => (
							<CommandItem
								key={command.name}
								className="hover:bg-[#2b2d3a] aria-selected:bg-[#2b2d3a]"
							>
