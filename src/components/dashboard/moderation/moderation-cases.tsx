            ...
            <div className="flex justify-center items-center p-12">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-400 max-w-md">
                        There are no moderation cases for this server yet. Cases will appear here when moderators take
                        action.
                    </p>
                </div>
            </div>
    ...
    return (
        <div className="space-y-4">
            <Table>
                ...
                <TableBody>
                    {cases.map(case_ => (
                        <TableRow key={case_.id} className="border-[#3a3d4a] hover:bg-[#232530]">
                  ...
                  `}
                            ...
                            <TableCell>{case_.moderator_id}</TableCell>
