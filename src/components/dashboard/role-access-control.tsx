    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Control which Discord roles can access your Sapphire dashboard</CardDescription>
            </CardHeader>
                ...
                <Alert>
                    ...
                    <AlertDescription>
                        ...
                        <ul className="mt-2 list-disc pl-5 space-y-1">
                            ...
                            <li>
                                <strong>Manage:</strong> Can modify settings but not critical ones
                            </li>
                            <li>
                ...
                <div className="space-y-4">
                    ...
                    {accessRoles.length === 0 ? (
                        <div className="text-sm text-muted-foreground border rounded-md p-4 text-center">
                            No roles have been added yet. Add a role below to grant dashboard access.
                        </div>
                    ) : (
